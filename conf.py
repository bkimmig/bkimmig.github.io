...
BLOG_AUTHOR = "Brian Kimmig"  # (translatable)
BLOG_TITLE = "Brian Kimmig's Site"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://bkimmig.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://bkimmig.github.io/"
BLOG_EMAIL = "brian.kimmig@gmail.com"
BLOG_DESCRIPTION = "Unread content."  # (translatable)
...
# configured from https://getnikola.com/creating-a-site-not-a-blog-with-nikola.html
POSTS = (
...
# lets make pages be the root - so we can have a homepage
# posts will still be blog oriented.
PAGES = (
